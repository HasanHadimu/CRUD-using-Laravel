        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Data Mahasiswa</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">Data Dosen</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="card-body">
                <a href="{{ url('/UploadPage') }}" class="btn btn-success">Tambah Data</a>
                        <br> <br>
                        ...
                        <table id="tabelcari" class="table table-bordered table-striped table-hover text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $data->email }}</td>
                                    <td>
                                        <img src="/storage/{{ $data->file }}" width="50">
                                    </td>
                                    <td>
                                        <a href="{{ url('/editpage',$data->id) }}" class="btn btn-success">Ubah</a>
                                        <a href="{{ url('/delete',$data->id) }}" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                            </tbody>
                            @endforeach
